...
- 固定应答数据结构
  ...
  - 详见 [Response](./src/main/java/com/github/fsixteen/common/structure/Response.java)
...
```xml
<dependency>
    <groupId>com.github.fsixteen</groupId>
...
```xml
implementation group: 'com.github.fsixteen', name: 'common-response-structure', version: '${new.version}'
```

- Ivy

```xml
<dependency org="com.github.fsixteen" name="common-response-structure" rev="${new.version}"/>
```
...
- 简单分页查询
    ...
    import com.github.fsixteen.common.structure.PageRequest;
    import com.github.fsixteen.common.structure.Response;
    import com.github.fsixteen.common.structure.Void;
...
- 扩展分页查询
  ...
  - Controller
      ...
      import com.github.fsixteen.common.structure.Response;
      import com.github.fsixteen.common.structure.Void;
      import com.github.fsixteen.gitlab.code.counter.request.SearchPageRequest;
...
- 快速应答
  - 详见 [Response](./src/main/java/com/github/fsixteen/common/structure/Response.java), [Ok](./src/main/java/com/github/fsixteen/common/structure/extend/Ok.java), [Err](./src/main/java/com/github/fsixteen/common/structure/extend/Err.java);
