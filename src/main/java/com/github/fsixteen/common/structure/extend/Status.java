...
import com.github.fsixteen.common.structure.StatusInterface;
import com.github.fsixteen.common.structure.utils.ProjectUtils;
 ...
 * @author FSixteen
 * @since V1.0.0
 * @see com.github.fsixteen.common.structure.constants.Constant#BUSS_LENGTH
 * @see com.github.fsixteen.common.structure.constants.Constant#PROJ_LENGTH
 * @see com.github.fsixteen.common.structure.constants.Constant#TYPE_LENGTH
 * @see com.github.fsixteen.common.structure.constants.Constant#VALI_LENGTH
 */
public interface Status {
    ...
    /** 通用, 操作成功, 默认 */
    public static final Supplier<StatusInterface> GENERAL_SUCCES = () -> bitOr(Type.GENERAL, Vali.SUCCES);
    /** 参数失败 */
    public static final Supplier<StatusInterface> ARGS_ERROR = () -> bitOr(Type.ARGS, Vali.ERROR);
    /** 参数成功 */
    public static final Supplier<StatusInterface> ARGS_SUCCES = () -> bitOr(Type.ARGS, Vali.SUCCES);
    /** 添加失败 */
    public static final Supplier<StatusInterface> INSERT_ERROR = () -> bitOr(Type.INSERT, Vali.ERROR);
    /** 添加成功 */
    public static final Supplier<StatusInterface> INSERT_SUCCES = () -> bitOr(Type.INSERT, Vali.SUCCES);
    /** 删除失败 */
    public static final Supplier<StatusInterface> DELETE_ERROR = () -> bitOr(Type.DELETE, Vali.ERROR);
    /** 删除成功 */
    public static final Supplier<StatusInterface> DELETE_SUCCES = () -> bitOr(Type.DELETE, Vali.SUCCES);
    /** 修改失败 */
    public static final Supplier<StatusInterface> UPDATE_ERROR = () -> bitOr(Type.UPDATE, Vali.ERROR);
    /** 修改成功 */
    public static final Supplier<StatusInterface> UPDATE_SUCCES = () -> bitOr(Type.UPDATE, Vali.SUCCES);
    /** 查询失败 */
    public static final Supplier<StatusInterface> SELECT_ERROR = () -> bitOr(Type.SELECT, Vali.ERROR);
    /** 查询成功 */
    public static final Supplier<StatusInterface> SELECT_SUCCES = () -> bitOr(Type.SELECT, Vali.SUCCES);
    /** 注册失败 */
    public static final Supplier<StatusInterface> REGIST_ERROR = () -> bitOr(Type.REGIST, Vali.ERROR);
    /** 注册成功 */
    public static final Supplier<StatusInterface> REGIST_SUCCES = () -> bitOr(Type.REGIST, Vali.SUCCES);
    /** 重置失败 */
    public static final Supplier<StatusInterface> RESET_ERROR = () -> bitOr(Type.RESET, Vali.ERROR);
    /** 重置成功 */
    public static final Supplier<StatusInterface> RESET_SUCCES = () -> bitOr(Type.RESET, Vali.SUCCES);
    /** 登录失败 */
    public static final Supplier<StatusInterface> LOGIN_ERROR = () -> bitOr(Type.LOGIN, Vali.ERROR);
    /** 登录成功 */
    public static final Supplier<StatusInterface> LOGIN_SUCCES = () -> bitOr(Type.LOGIN, Vali.SUCCES);
    /** 登出失败 */
    public static final Supplier<StatusInterface> LOGOUT_ERROR = () -> bitOr(Type.LOGOUT, Vali.ERROR);
    /** 登出成功 */
    public static final Supplier<StatusInterface> LOGOUT_SUCCES = () -> bitOr(Type.LOGOUT, Vali.SUCCES);
    /** 权限失败 */
    public static final Supplier<StatusInterface> PERMISSION_ERROR = () -> bitOr(Type.PERMISSION, Vali.ERROR);
    /** 权限成功 */
    public static final Supplier<StatusInterface> PERMISSION_SUCCES = () -> bitOr(Type.PERMISSION, Vali.SUCCES);
    /** 上传失败 */
    public static final Supplier<StatusInterface> UPLOAD_ERROR = () -> bitOr(Type.UPLOAD, Vali.ERROR);
    /** 上传成功 */
    public static final Supplier<StatusInterface> UPLOAD_SUCCES = () -> bitOr(Type.UPLOAD, Vali.SUCCES);
    /** 下载失败 */
    public static final Supplier<StatusInterface> DOWNLOAD_ERROR = () -> bitOr(Type.DOWNLOAD, Vali.ERROR);
    /** 下载成功 */
    public static final Supplier<StatusInterface> DOWNLOAD_SUCCES = () -> bitOr(Type.DOWNLOAD, Vali.SUCCES);
    /** 检测失败 */
    public static final Supplier<StatusInterface> CHECK_ERROR = () -> bitOr(Type.CHECK, Vali.ERROR);
    /** 检测成功 */
    public static final Supplier<StatusInterface> CHECK_SUCCES = () -> bitOr(Type.CHECK, Vali.SUCCES);
    /** 检测失败 */
    public static final Supplier<StatusInterface> WARNING_ERROR = () -> bitOr(Type.WARNING, Vali.ERROR, Type.WARNING.msg());
    /** 检测成功 */
    public static final Supplier<StatusInterface> WARNING_SUCCES = () -> bitOr(Type.WARNING, Vali.SUCCES, Type.WARNING.msg());
    /** 开始失败 */
    public static final Supplier<StatusInterface> START_ERROR = () -> bitOr(Type.START, Vali.ERROR, Type.WARNING.msg());
    /** 开始成功 */
    public static final Supplier<StatusInterface> START_SUCCES = () -> bitOr(Type.START, Vali.SUCCES, Type.WARNING.msg());
    /** 暂停失败 */
    public static final Supplier<StatusInterface> PAUSE_ERROR = () -> bitOr(Type.PAUSE, Vali.ERROR, Type.WARNING.msg());
    /** 暂停成功 */
    public static final Supplier<StatusInterface> PAUSE_SUCCES = () -> bitOr(Type.PAUSE, Vali.SUCCES, Type.WARNING.msg());
    /** 结束失败 */
    ...
    /** 其他成功 */
    public static final Supplier<StatusInterface> OTHERS_SUCCES = () -> bitOr(Type.OTHERS, Vali.SUCCES);
