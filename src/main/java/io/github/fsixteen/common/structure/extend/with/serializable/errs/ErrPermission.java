...
public interface ErrPermission {
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithExts(final T data, final E exts) {
        return Response.ofExts(Status.PERMISSION_ERROR.get(), data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithExts(final T data, final E exts, final long totalElements) {
        return Response.ofExts(Status.PERMISSION_ERROR.get(), data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithExts(final T data, final E exts, final long page,
        ...
        return Response.ofExts(Status.PERMISSION_ERROR.get(), data, exts, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithExts(final T data, final E exts, final String msg) {
        return Response.ofExts(Status.PERMISSION_ERROR.get().code(), msg, data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithExts(final T data, final E exts, final long totalElements,
            final String msg) {
        return Response.ofExts(Status.PERMISSION_ERROR.get().code(), msg, data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithExts(final T data, final E exts, final long page,
        ...
        return Response.ofExts(Status.PERMISSION_ERROR.get().code(), msg, data, exts, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithSercExts(final long serviceCode, final T data, final E exts) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.PERMISSION_ERROR.get()), data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithSercExts(final long serviceCode, final T data, final E exts,
            final long totalElements) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.PERMISSION_ERROR.get()), data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithSercExts(final long serviceCode, final T data, final E exts,
        ...
        return Response.ofExts(Status.bitOr(serviceCode, Status.PERMISSION_ERROR.get()), data, exts, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithSercExts(final long serviceCode, final T data, final E exts,
            final String msg) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.PERMISSION_ERROR.get(), msg), data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithSercExts(final long serviceCode, final T data, final E exts,
            final long totalElements, final String msg) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.PERMISSION_ERROR.get(), msg), data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> permissionWithSercExts(final long serviceCode, final T data, final E exts,
        ...
        return Response.ofExts(Status.bitOr(serviceCode, Status.PERMISSION_ERROR.get(), msg), data, exts, page, size, totalElements);
    }
