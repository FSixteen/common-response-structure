...
public interface OkNondata {
    ...
    public static <T extends Serializable> SimpleResponse<T> nondata() {
        return Response.of(Status.NONDATA_SUCCESS.get());
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondata(final T data) {
        return Response.of(Status.NONDATA_SUCCESS.get(), data);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondata(final T data, final long totalElements) {
        return Response.of(Status.NONDATA_SUCCESS.get(), data, totalElements);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondata(final T data, final long page, final long size, final long totalElements) {
        return Response.of(Status.NONDATA_SUCCESS.get(), data, page, size, totalElements);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondata(final T data, final String msg) {
        return Response.of(Status.NONDATA_SUCCESS.get().code(), msg, data);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondata(final T data, final long totalElements, final String msg) {
        return Response.of(Status.NONDATA_SUCCESS.get().code(), msg, data, totalElements);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondata(final T data, final long page, final long size, final long totalElements,
        final String msg) {
        return Response.of(Status.NONDATA_SUCCESS.get().code(), msg, data, page, size, totalElements);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondataWithSerc(final long serviceCode) {
        return Response.of(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get()));
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondataWithSerc(final long serviceCode, final T data) {
        return Response.of(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get()), data);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondataWithSerc(final long serviceCode, final T data, final long totalElements) {
        return Response.of(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get()), data, totalElements);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondataWithSerc(final long serviceCode, final T data, final long page, final long size,
        ...
        return Response.of(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get()), data, page, size, totalElements);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondataWithSerc(final long serviceCode, final T data, final String msg) {
        return Response.of(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get(), msg), data);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondataWithSerc(final long serviceCode, final T data, final long totalElements, final String msg) {
        return Response.of(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get(), msg), data, totalElements);
    }
    ...
    public static <T extends Serializable> SimpleResponse<T> nondataWithSerc(final long serviceCode, final T data, final long page, final long size,
        ...
        return Response.of(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get(), msg), data, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithExts(final T data, final E exts) {
        return Response.ofExts(Status.NONDATA_SUCCESS.get(), data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithExts(final T data, final E exts, final long totalElements) {
        return Response.ofExts(Status.NONDATA_SUCCESS.get(), data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithExts(final T data, final E exts, final long page, final long size,
        final long totalElements) {
        return Response.ofExts(Status.NONDATA_SUCCESS.get(), data, exts, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithExts(final T data, final E exts, final String msg) {
        return Response.ofExts(Status.NONDATA_SUCCESS.get().code(), msg, data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithExts(final T data, final E exts, final long totalElements,
        final String msg) {
        return Response.ofExts(Status.NONDATA_SUCCESS.get().code(), msg, data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithExts(final T data, final E exts, final long page, final long size,
        final long totalElements, final String msg) {
        return Response.ofExts(Status.NONDATA_SUCCESS.get().code(), msg, data, exts, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithSercExts(final long serviceCode, final T data, final E exts) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get()), data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithSercExts(final long serviceCode, final T data, final E exts,
        final long totalElements) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get()), data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithSercExts(final long serviceCode, final T data, final E exts,
        ...
        return Response.ofExts(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get()), data, exts, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithSercExts(final long serviceCode, final T data, final E exts,
        final String msg) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get(), msg), data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithSercExts(final long serviceCode, final T data, final E exts,
        final long totalElements, final String msg) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get(), msg), data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> nondataWithSercExts(final long serviceCode, final T data, final E exts,
        ...
        return Response.ofExts(Status.bitOr(serviceCode, Status.NONDATA_SUCCESS.get(), msg), data, exts, page, size, totalElements);
    }
