...
public interface ErrUpload {
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithExts(final T data, final E exts) {
        return Response.ofExts(Status.UPLOAD_ERROR.get(), data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithExts(final T data, final E exts, final long totalElements) {
        return Response.ofExts(Status.UPLOAD_ERROR.get(), data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithExts(final T data, final E exts, final long page, final long size,
        final long totalElements) {
        return Response.ofExts(Status.UPLOAD_ERROR.get(), data, exts, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithExts(final T data, final E exts, final String msg) {
        return Response.ofExts(Status.UPLOAD_ERROR.get().code(), msg, data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithExts(final T data, final E exts, final long totalElements,
        final String msg) {
        return Response.ofExts(Status.UPLOAD_ERROR.get().code(), msg, data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithExts(final T data, final E exts, final long page, final long size,
        final long totalElements, final String msg) {
        return Response.ofExts(Status.UPLOAD_ERROR.get().code(), msg, data, exts, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithSercExts(final long serviceCode, final T data, final E exts) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.UPLOAD_ERROR.get()), data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithSercExts(final long serviceCode, final T data, final E exts,
        final long totalElements) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.UPLOAD_ERROR.get()), data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithSercExts(final long serviceCode, final T data, final E exts,
        ...
        return Response.ofExts(Status.bitOr(serviceCode, Status.UPLOAD_ERROR.get()), data, exts, page, size, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithSercExts(final long serviceCode, final T data, final E exts,
        final String msg) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.UPLOAD_ERROR.get(), msg), data, exts);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithSercExts(final long serviceCode, final T data, final E exts,
        final long totalElements, final String msg) {
        return Response.ofExts(Status.bitOr(serviceCode, Status.UPLOAD_ERROR.get(), msg), data, exts, totalElements);
    }
    ...
    public static <T extends Serializable, E extends Serializable> Response<T, E> uploadWithSercExts(final long serviceCode, final T data, final E exts,
        ...
        return Response.ofExts(Status.bitOr(serviceCode, Status.UPLOAD_ERROR.get(), msg), data, exts, page, size, totalElements);
    }
