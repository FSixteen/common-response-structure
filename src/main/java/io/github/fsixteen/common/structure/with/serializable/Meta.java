...
public final class Meta<T extends Serializable, E extends Serializable> implements Serializable {
     ...
     * @return Meta&lt;T, E&gt;
     */
    public static <T extends Serializable, E extends Serializable> Meta<T, E> of(final T data) {
     ...
     * @return Meta&lt;T, E&gt;
     */
    public static <T extends Serializable, E extends Serializable> Meta<T, E> of(final T data, final PageInfo page) {
     ...
     * @return Meta&lt;T, E&gt;
     */
    public static <T extends Serializable, E extends Serializable> Meta<T, E> of(final T data, final E exts, final PageInfo page) {
